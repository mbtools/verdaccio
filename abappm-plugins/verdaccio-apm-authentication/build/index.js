...
__export(src_exports, {
  AuthPlugin: () => auth_plugin_default,
  default: () => src_default
});
...
var password = env_default.DATABASE_SECRET;
var algorithm = "aes-192-cbc";
var keyLength = 24;
var salt = "saltypretzel";
...
var debug2 = (0, import_debug2.default)("verdaccio:plugin:apm:auth");
...
var DEFAULT_MAX_USERS = Infinity;
var DEFAULT_SLOW_VERIFY_MS = 300;
var debug3 = (0, import_debug3.default)("verdaccio:plugin:apm:auth");
var AuthPlugin = class extends import_core3.pluginUtils.Plugin {
  constructor(config2, options) {
    ...
    this.authConfig = {
      url: config2.url || env_default.DATABASE_URL,
      rounds: config2.rounds || DEFAULT_ROUNDS,
      max_users: config2.max_users || DEFAULT_MAX_USERS,
      slow_verify_ms: config2.slow_verify_ms || DEFAULT_SLOW_VERIFY_MS
    };
  ...
  // @ts-expect-error: adduser is not part of the Auth interface (yet)
  async adduser(user, password2, email, cb) {
...
var auth_plugin_default = AuthPlugin;

// src/index.ts
var src_default = auth_plugin_default;
