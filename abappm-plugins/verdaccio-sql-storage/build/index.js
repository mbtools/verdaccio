...
// src/storage-handler.ts
var debug8 = (0, import_debug8.default)("verdaccio:plugin:storage:sql");
var SqlStorageHandler = class {
  ...
  // TODO - replace with hasPackage(name)
  // public async hasPackage(packageName: string): Promise<boolean> {
  async hasPackage() {
    debug8("has package %o", this.packageName);
    return this.package.exists(this.packageName);
  }
  ...
  // TODO - replace with removePackage(packageName)
  async deletePackage(filename) {
    debug8("remove package %o", filename);
    if (filename === "package.json") {
      await this.package.delete(this.packageName);
    } else {
  ...
  async removePackage() {
    debug8("remove package %o", this.packageName);
    return this.package.delete(this.packageName);
  }
...
// src/storage-plugin.ts
var debug9 = (0, import_debug9.default)("verdaccio:plugin:storage:sql");
...
// src/index.ts
var src_default = storage_plugin_default;
